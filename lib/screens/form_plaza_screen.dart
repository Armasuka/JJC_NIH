...
class _FormPlazaScreenState extends State<FormPlazaScreen> {
  ...
  final List<String> kelengkapanSaranaList = [
    'Bendera Merah', 'Kabel Jumper', 'Kunci Panjang', 'Dongkrak buaya',
    'Jerigen Plastik', 'Senter Biasa', 'Kunci Tool Kit', 'Roll Meter',
    'Clip Board', 'Sarung Tangan', 'Plat Besi', 'Linggis',
    'Kacamata Safety', 'Rubbercone', 'Serbuk Gergaji', 'Skop',
    'Sapu lidi', 'Lap Kanebo', 'Apar'
  ];

  final List<String> kelengkapanKendaraanList = [
    'Kaca Spion Luar', 'Kaca Spion Dalam', 'Lampu Kecil', 'Lampu Besar',
    'Lampu Sorot', 'Lampu Sein Depan', 'Lampu Sein Belakang', 'Lampu Rem',
    'Rotator', 'Ban Depan & Velg', 'Ban Belakang &Velg', 'Ban Cadangan & Velg',
    'Radio Komunikasi / Antena', 'Handy Talky & Charger', 'Amply / Public Address',
    'Kunci Roda', 'Sirine', 'Rak Rambu', 'Box Besi', 'Perlengkapan P3K'
  ];
  ...
  Future<void> _clearDraft() async {
    ...
    final draftKey = widget.draftKey ?? 'plaza_draft';
  ...
  void _checkForSavedDraft() {
    final draftExists = DraftService.loadDraft('plaza_draft') != null;
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          ...
          builder: (context) => SuccessScreen(
            title: 'Form Plaza Berhasil Disimpan',
            message: 'Data inspeksi kendaraan Plaza telah berhasil disimpan dan PDF telah dibuat.',
