...
class _FormKamtibScreenState extends State<FormKamtibScreen> {
  ...
  final List<String> kelengkapanSaranaList = [
    // Kamtib tidak ada kelengkapan sarana
  ];
  ...
  void dispose() {
    ...
    for (var map in [kelengkapanPetugas, kelengkapanKendaraan]) {
  ...
  Future<void> _clearDraft() async {
    ...
    final draftKey = widget.draftKey ?? 'kamtib_draft';
  ...
  void _checkForSavedDraft() {
    final draftExists = DraftService.loadDraft('kamtib_draft') != null;
