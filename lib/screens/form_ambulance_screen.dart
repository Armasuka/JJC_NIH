    ...
    try {
      ...
      if (draftData != null) {
        setState(() {
          ...
          if (photos['sertifikatParamedis'] != null) fotoSertifikatParamedis = File(photos['sertifikatParamedis'] as String);
                              ...
                              child: pw.Column(
                                ...
                                children: [
                                  pw.Text('PT JASAMARGA JALANLAYANG CIKAMPEK', 
                                    style: pw.TextStyle(fontWeight: pw.FontWeight.bold, font: fontBold, fontSize: 12)),
                                  pw.Text('FORM INSPEKSI AMBULANCE', 
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          ...
          builder: (context) => SuccessScreen(
            ...
            message: 'Data inspeksi kendaraan Ambulance telah berhasil disimpan dan PDF telah dibuat.',
